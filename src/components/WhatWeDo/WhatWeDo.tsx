...
import attorneys from '../../assets/images/content-01-attorneys.jpg';
                    ...
                    <div>
                        ...
                        <div className={classes.line_2}></div>
                                ...
                                <div className={classes.sidenav_content}>
                                    <div className={classes.box1}>
                                        ...
                                        <h4 style={{ fontWeight: 'bold' }}>Litigation</h4>
                                            ...
                                            <li>Brokerage Agreement</li>
                                            <li>Business Formation</li>
                                        <img className={classes.attorney_img} src={attorneys} alt="NZA logo" />
                            ...
                            <div className={classes.box3}>
                                <img src={business} alt="missing img"/>
                                <img src={litigation} alt="missing img"/>
                                <img src={subrogation} alt="missing img"/>
                                <img src={warehouse} alt="missing img"/>
                            </div>
                    </div>
